              ...
              <div className="flex justify-end h-[72px] gap-12 pr-8 right-8">
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex gap-1">
                    ...
                    <img className="cursor-pointer" src={Bottom} alt="Arrow Img" />
                  </div>
                </div>
                <div className="flex gap-6 items-center">
                  ...
                  <div className="flex gap-3">
                    <img className="cursor-pointer" src={Left} alt="Left Arrow" />
                    <img className="cursor-pointer rotate-180" src={Left} alt="Left Arrow" />
                  </div>
                </div>
              </div>
            </div>
